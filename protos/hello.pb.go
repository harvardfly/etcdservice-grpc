...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0x1d, 0xa6, 0x0e, 0xc6, 0x35, 0x72, 0xe5, 0xe2, 0x06, 0x2b, 0x0d, 0x4e, 0x2d, 0x2a, 0x4b, 0x2d,
	0x12, 0x32, 0xe3, 0x62, 0x0d, 0x4e, 0xac, 0xf4, 0xc8, 0x14, 0x12, 0x81, 0x58, 0x5b, 0xac, 0x87,
	0x6c, 0x99, 0x94, 0x28, 0x9a, 0x28, 0xc4, 0x78, 0x25, 0x86, 0x24, 0x88, 0xeb, 0x8c, 0x01, 0x01,
	0x00, 0x00, 0xff, 0xff, 0xe7, 0x52, 0xfc, 0x87, 0xb3, 0x00, 0x00, 0x00,
}
...
func (c *helloServerClient) SayHi(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, "/protos.HelloServer/SayHi", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedHelloServerServer) SayHi(ctx context.Context, req *HelloRequest) (*HelloResponse, error) {
...
func _HelloServer_SayHi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.HelloServer/SayHi",
	}
...
var _HelloServer_serviceDesc = grpc.ServiceDesc{
	ServiceName: "protos.HelloServer",
